...
import { useGetArtfairListQuery } from "../Store/Store";

const Artfair = ({module}) => {

    const [currentPage, setCurrentPage] = useState(1);
    const [searchTerm, setSearchTerm] = useState("");

    const { data , isLoading} = useGetArtfairListQuery({
        page: currentPage,
        search: searchTerm,
      });
      console.log("all data Artfairposts", data)
    ...
    return (
        <>
            ...
            <div className="admin-wrapper-table">
                ...
                <p style={{fontSize: "2rem", color: "#fff", fontWeight: "800" }}>Artfair</p>
                                        ...
                                        currentPosts?.map((datas, index) => (
                                            <tr>
                                                ...
                                                <td className="text-center">
                                                    <Link
                                                to={`/artfair-list-info/${datas._id}`}
                                                >
