...
import { useGetTeamsListQuery } from "../Store/Store";
                    ...
                    <tr>
                      ...
                      {module?.NewsModule?.Write && (
                        <td className="text-center">
                          <Link to={`/edit-teams/${encodeURIComponent(encryptedItemId)}`}>
                      ...
                      {module?.NewsModule?.Read && (
                        <td className="text-center">
                          <Link to={`/view-teams/${encodeURIComponent(encryptedItemId)}`}>
