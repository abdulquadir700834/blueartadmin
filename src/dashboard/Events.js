...
import { useGetEventsListQuery } from "../Store/Store";
...
const Events = ({ module }) => {
  ...
  const { data, isLoading, isError } = useGetEventsListQuery({
    page: currentPage,
    search: searchTerm,
  });
                    ...
                    <tr>
                      ...
                      {module?.NewsModule?.Write && (
                        <td className="text-center">
                          <Link to={`/edit-events/${encodeURIComponent(encryptedItemId)}`}>
                      ...
                      {module?.NewsModule?.Read && (
                        <td className="text-center">
                          <Link to={`/view-events/${encodeURIComponent(encryptedItemId)}`}>
