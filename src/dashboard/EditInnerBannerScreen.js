...
const EditInnerBannerScreen = ({ setting }) => {
  const { key, cdn } = useParams();
  let navigate = useNavigate();
  console.log("keyValues:", key, cdn)
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      axios
        .post(
          `${process.env.REACT_APP_BACKEND_URL}UpdateInnerBannerImage`,
          formData,
          config,
          {}
        )
        .then((res) => {
          ...
          if (res?.data?.status) {
            ...
            axios
              .post(
                `${process.env.REACT_APP_BACKEND_URL}UpdateInnerBanner`,
                obj,
                config,
                {}
              )
            ...
            setTimeout(() => navigate("/inner-banner"), 1000);
          } else {
          ...
          <div className="row g-4 justify-content-center">
            <div className='d-flex flex-wrap justify-content-end px-5'>
              <div className=''>
                <div className='btn-right'>
                  <Link className="btn btn-danger  btn-sm w-10" to="/inner-banner" >
            ...
            <div className="col-12 col-lg-10 col-xl-9 col-xxl-8">
              <Tabs className="border-0 mb-3 settings-tabs">
                <Tab eventKey="" title="Edit Inner Banner">
                  <div className="card">
                          ...
                          <div className="container pt-3">
                            <div className="row align-items-center">
                              ...
                              <div className="col">
                                ...
                                {inputImage === "" ? (
                                  <div>
                                    <img src={decodeURIComponent(cdn)}
                                      onClick={() => handleImageClick(cdn)} />
                                  </div>
                                ) : (
                                  <img src={inputImage}
                                    onClick={() => handleImageClick(inputImage)} />
                                )}
...
export default EditInnerBannerScreen