...
import { useGetArtistMediumListQuery } from "../Store/Store";
...
const ArtistMedium = () => {
    ...
    const { data, isLoading } = useGetArtistMediumListQuery({
        page: currentPage,
        search: searchTerm,
    });
                    ...
                    <div className="row">
                        ...
                        <div className='col-md-4 ms-auto'>
                            <div className='btn-right'>
                                <Link className="btn btn-warning rounded-pill btn-sm w-10" to="/add-artist-medium">
                                    Add Artist Medium List
                                </Link>
                            </div>
                        </div>
                    </div>
                                        ...
                                        return (
                                            <tr>
                                                ...
                                                <td className="text-center">
                                                    <Link
                                                        to={`/edit-artist-medium/${encodeURIComponent(encryptedItemId)}`}
                                                    >
