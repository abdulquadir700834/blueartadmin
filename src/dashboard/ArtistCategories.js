...
import { useGetArtistCategoryListQuery } from "../Store/Store";
...
const ArtistCategories = () => {
    ...
    const { data, isLoading } = useGetArtistCategoryListQuery({
        page: currentPage,
        search: searchTerm,
    });
                    ...
                    <div className="row">
                        ...
                        <div className='col-md-4 ms-auto'>
                            <div className='btn-right'>
                                <Link className="btn btn-warning rounded-pill btn-sm w-10" to="/add-artist">
                                        ...
                                        return (
                                            <tr>
                                                ...
                                                <td className="text-center">
                                                    <Link
                                                        to={`/edit-artist/${encodeURIComponent(encryptedItemId)}`}
                                                    >
