...
import { useGetArtistStyleListQuery } from "../Store/Store";
...
const ArtistStyle = () => {
    ...
    const { data, isLoading } = useGetArtistStyleListQuery({
        page: currentPage,
        search: searchTerm,
    });
                    ...
                    <div className="row">
                        ...
                        <div className='col-md-4 ms-auto'>
                            <div className='btn-right'>
                                <Link className="btn btn-warning rounded-pill btn-sm w-10" to="/add-artist-style">
                                    Add Artist Style List
                                </Link>
                            </div>
                        </div>
                    </div>
                                        ...
                                        return (
                                            <tr>
                                                ...
                                                <td className="text-center">
                                                    <Link
                                                        to={`/edit-artist-style/${encodeURIComponent(encryptedItemId)}`}
                                                    >
