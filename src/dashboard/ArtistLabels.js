...
import { useGetArtistLabelListQuery } from "../Store/Store";
...
const ArtistLabels = () => {
    ...
    const { data, isLoading } = useGetArtistLabelListQuery({
        page: currentPage,
        search: searchTerm,
    });
                    ...
                    <div className="row">
                        ...
                        <div className='col-md-4 ms-auto'>
                            <div className='btn-right'>
                                <Link className="btn btn-warning rounded-pill btn-sm w-10" to="/add-artist-label"
                                >
                                    Add Artist Labels
                                </Link>
                            </div>
                                        ...
                                        return (
                                            <tr>
                                                ...
                                                <td className="text-center">
                                                    <Link
                                                        to={`/edit-artist-label/${encodeURIComponent(encryptedItemId)}`}
                                                    >
                                                ...
                                                <td className="text-center">
                                                    <Link to={`/view-artist-label/${encodeURIComponent(encryptedItemId)}`}>
