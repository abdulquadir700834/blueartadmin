...
const EditArtistMedium = () => {
  const { id } = useParams();
  let navigate = useNavigate();
  const [showCategory, setShowCategory] = useState({});
  const [editdates, responseInfo2] = useGetOneArtistMediumMutation();
  const [editCategory, responseInfo] = useEditArtistMediumMutation();
  ...
  useEffect(() => {
    if (responseInfo?.data?.status) {
      ...
      setTimeout(() => navigate("/artist-medium"), 2000);
    } else {
          ...
          <div className="row g-4 justify-content-center">
            <div className='d-flex flex-wrap justify-content-end px-5'>
              <div className=''>
                <div className='btn-right'>
                  <Link className="btn btn-danger  btn-sm w-10" to="/artist-medium" >
            ...
            <div className="col-12 col-lg-10 col-xl-9 col-xxl-8">
              <Tabs className="border-0 mb-3 settings-tabs">
                <Tab eventKey="" title="Edit Artist Medium">
                  <div className="card">
                        ...
                        <div className="row g-4">
                          <div className="col-12">
                            <input
                              ...
                              id="name"
                              name="title"
                              placeholder="Your Artist Medium..."
...
export default EditArtistMedium