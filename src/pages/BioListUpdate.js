...
import { useGetBioListMoreInfoMutation, useSingleUserDetailsQuery, useUpdateBiolistMutation } from "../Store/Store";
...
const BioListUpdate = () => {
  ...
  const [createPost2, responseInfo2] = useGetBioListMoreInfoMutation()
  const [createPost, responseInfo] = useUpdateBiolistMutation();
    ...
    onSubmit: (values) => {
      ...
      createPost(postData).then(res => {
        if (res?.data?.status !== false) {
          ...
          setTimeout(() => navigate("/bio-list"), 1500);
        } else {
          ...
          <div className="row g-4 justify-content-center">
            ...
            <div className="col-12 col-lg-10 col-xl-9 col-xxl-8">
              <Tabs className="border-0 mb-3 settings-tabs">
                <Tab eventKey="" title="Edit Bio List">
                  <div className="card">
