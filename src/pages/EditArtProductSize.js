...
const EditArtProductSize = () => {
  let navigate = useNavigate();
  const { id } = useParams();
  const [isLoading, setIsLoading] = useState(false);
  const [showCategory, setShowCategory] = useState({});
  const [editdates, responseInfo2] = useUpdateArtProductSizeSectionMutation();
  const [editCategory, responseInfo] = useEditArtProductSizeMutation();
  ...
  useEffect(() => {
    if (responseInfo?.data?.status) {
      ...
      setTimeout(() => navigate("/artproductsize"), 2000);
    } else {
          ...
          <div className="row g-4 justify-content-center">
            <div className='d-flex flex-wrap justify-content-end px-5'>
              <div className=''>
                <div className='btn-right'>
                  <Link className="btn btn-danger  btn-sm w-10" to="/artproductsize" >
            ...
            <div className="col-12 col-lg-10 col-xl-9 col-xxl-8">
              <Tabs className="border-0 mb-3 settings-tabs">
                <Tab eventKey="" title="Edit Art Product Size">
                  <div className="card">
                        ...
                        <div className="row g-4">
                          <div className="col-12">
                            <input
                              ...
                              id="name"
                              name="title"
                              placeholder="Your Product Size Title..."
...
export default EditArtProductSize