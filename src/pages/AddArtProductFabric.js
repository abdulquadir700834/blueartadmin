...
const AddArtProductFabric = () => {
  let navigate = useNavigate();
  const [categoryTitle, setCategoryTitle] = useState("");
  const [categoryStatus, setCategoryStatus] = useState("Active");
  const [addMaterial, responseInfo] = useAddArtProductFabricMutation();
          ...
          <div className="row g-4 justify-content-center">
            ...
            <div className="col-12 col-lg-10 col-xl-9 col-xxl-8">
              <Tabs className="border-0 mb-3 settings-tabs">
                <Tab eventKey="" title="Add Art Product Fabric">
                  <div className="card">
...
export default AddArtProductFabric;
