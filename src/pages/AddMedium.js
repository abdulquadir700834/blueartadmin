...
const AddMedium = () => {
  ...
  const [addMedium, responseInfo] = useAddMediumMutation();
  ...
  const handleSubmit = async (e) => {
    ...
    if (!categoryTitle) {
      setIsLoading(false)
      toast.error("Please enter a Medium");
      return;
    }
    await addMedium(newPost);
  }
