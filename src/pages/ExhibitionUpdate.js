...
import { useGetExhibitionMoreInfoMutation, useSingleUserDetailsQuery, useUpdateExhibitionMutation } from "../Store/Store";
...
const ExhibitionUpdate = () => {
  ...
  const [createPost2, responseInfo2] = useGetExhibitionMoreInfoMutation()
  const [createPost, responseInfo] = useUpdateExhibitionMutation();
    ...
    onSubmit: (values) => {
      ...
      createPost(postData).then(res => {
        if (res?.data?.status !== false) {
          ...
          setTimeout(() => navigate("/exhibition"), 1500);
          ...
          <div className="row g-4 justify-content-center">
            ...
            <div className="col-12 col-lg-10 col-xl-9 col-xxl-8">
              <Tabs className="border-0 mb-3 settings-tabs">
                <Tab eventKey="" title="Edit Exhibition">
                  <div className="card">
