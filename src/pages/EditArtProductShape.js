...
const EditArtProductShape = () => {

  const { id } = useParams();
  let navigate = useNavigate();
  const [showCategory, setShowCategory] = useState({});
  const [editdates, responseInfo2] = useUpdateArtProductShapeSectionMutation();
  const [editCategory, responseInfo] = useEditArtProductShapeMutation();
  ...
  useEffect(() => {
    if (responseInfo?.data?.status) {
      ...
      setTimeout(() => navigate("/artproductshape"), 2000);
    } else {
          ...
          <div className="row g-4 justify-content-center">
            <div className='d-flex flex-wrap justify-content-end px-5'>
              <div className=''>
                <div className='btn-right'>
                  <Link className="btn btn-danger  btn-sm w-10" to="/artproductshape" >
            ...
            <div className="col-12 col-lg-10 col-xl-9 col-xxl-8">
              <Tabs className="border-0 mb-3 settings-tabs">
                <Tab eventKey="" title="Edit Art Product Shape">
                  <div className="card">
...
export default EditArtProductShape