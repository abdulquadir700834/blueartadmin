...
const ViewNewsAuthor = () => {
  ...
  useEffect(() => {
    if (responseInfo?.data?.status) {
      ...
      setTimeout(() => (window.location.href = "/news-author"), 2000);
    } else {
          ...
          <div className="row g-4 justify-content-center">
            ...
            <div className="col-12 col-lg-10 col-xl-9 col-xxl-8">
              <Tabs className="border-0 mb-3 settings-tabs">
                <Tab eventKey="" title="View News Author">
                  <div className="card">
                      ...
                      <Form onSubmit={handleSubmit}>
                        <div className="row g-4">
                          ...
                          <div className='col-12 d-flex flex-wrap align-items-center'>
                            ...
                            <div className='col-6'>
                              <img src={showCategory?.Image} style={{
                                height: "80px",
                                width: "80px"
