...
import {
    useGetArtworksMoreInfoMutation, useGetEditartItemAccountMoreInfoMutation, useGetArtEditionMoreInfoMutation
} from "../Store/Store";
...
const EditArtwork = () => {
    ...
    const getEditionData = async (page = 1) => {
        ...
        console.log(getEditionDetails, "details")
    }

    console.log("editionData:", responseInfo3.data)
    ...
    const getOneData = async () => {
        ...
        console.log("ApprovestatusValue:", showCategory[0]?.ApproveStatus)
    ...
    const getEditArtItem = async (status) => {
        ...
        console.log(updateEditItem, "details")
    }
    ...
    const handleClick = () => {
        ...
        console.log("newApproveStatus:", newApproveStatus)
        // Call the API with the newApproveStatus value
    ...
    useEffect(() => {
        if (responseInfo?.data?.status) {
            ...
            setTimeout(() => navigate("/artwork"), 1000);
        } else {
                    ...
                    <div className="row g-4 justify-content-center">
                        <div className='d-flex flex-wrap justify-content-end px-5'>
                            <div className=''>
                                <div className='btn-right'>
                                    <Link className="btn btn-danger  btn-sm w-10" to="/artwork" >
                        ...
                        <div className="col-12">
                            <Tabs className="border-0 mb-3 settings-tabs px-3">
                                <Tab eventKey="" title="Artwork Info">
                                </Tab>
                            </Tabs>
                        </div>
                            ...
                            <Row>
                                <Col sm={3} className="py-4">
                                    <Nav variant="pills" className="flex-column">
                                        <p style={{ fontSize: "2rem", color: "#fff", fontWeight: "800" }}>Artwork Info</p>
                                        <div className="card">
                                                    ...
                                                    <Form >
                                                        ...
                                                        <div className="container">
                                                            <div className="row align-items-center">
                                                                ...
                                                                <div className='col-6'>
                                                                    <p className='text-white'>{showCategory[0]?.Category}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="container">
                                                            <div className="row align-items-center">
                                                                ...
                                                                <div className='col-6'>
                                                                    <p className='text-white'>{showCategory[0]?.Color}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="container">
                                                            <div className="row align-items-center">
                                                                ...
                                                                <div className='col-6'>
                                                                    <p className='text-white'>{showCategory[0]?.Orientation}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="container">
                                                            <div className="row align-items-center">
                                                                ...
                                                                <div className='col-6'>
                                                                    <p className='text-white'>{String(showCategory[0]?.Material)}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="container">
                                                            <div className="row align-items-center">
                                                                ...
                                                                <div className='col-6'>
                                                                    <p className='text-white'>{String(showCategory[0]?.Style)}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="container">
                                                            <div className="row align-items-center">
                                                                ...
                                                                <div className='col-6'>
                                                                    <p className='text-white'>{showCategory[0]?.Subject}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="container">
                                                            <div className="row align-items-center">
                                                                ...
                                                                <div className='col-6'>
                                                                    <p className='text-white'>{showCategory[0]?.Keywords}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div className="card-body p-4 p-sm-5">
                                                    <Form >
                                                        ...
                                                        <div className="container">
                                                            <div className="row align-items-center">
                                                                <div className='col-6'>
                                                                    <p className='text-white'>Auto Accept Offers</p>
                                                                </div>
                                                                <div className='col-6'>
                                                        ...
                                                        <div className="container">
                                                            <div className="row align-items-center">
                                                                <div className='col-6'>
                                                                    <p className='text-white'>Auto Reject Offers</p>
                                                                </div>
                                                                <div className='col-6'>
                                                                    <p className='text-white'>{showCategory[0]?.AutoRejectOffers ? "Yes" : "No"}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </Form>
