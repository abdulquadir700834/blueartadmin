...
import { useGetSingleCareerQuery } from '../../../Store/Store'
import Form from "react-bootstrap/Form";
import Tabs from "react-bootstrap/Tabs";
import Tab from "react-bootstrap/Tab";
import { toast,ToastContainer } from "react-toastify";
import { useEditCareerMutation } from '../../../Store/Store';
const EditCareer = () => {
    const {id}=useParams();
    const initialState = {
        id:id,
    ...
    const {data,responseInfo}=useGetSingleCareerQuery(id);
    console.log("single terms data",data)
    const [editCareer,editInfo]=useEditCareerMutation();
    ...
    useEffect(() => {
        ...
        if(editInfo?.data?.status === true) {
            ...
            setTimeout(() => (window.location.href = "/career"), 2000);
        } else {
        ...
        <div className="row g-4 justify-content-center">
          <div className="col-12 col-lg-10 col-xl-9 col-xxl-8">
            <Tabs className="border-0 mb-3 settings-tabs">
              <Tab eventKey="" title="Update Career">
                <div className="card"> 
