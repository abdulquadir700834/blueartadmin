...
import { useGetHelpCenterQuery } from '../../../Store/Store';
import { toast, ToastContainer } from "react-toastify";
import { useDeleteHelpCenterMutation } from '../../../Store/Store'
import Pagination from '../../Pagination';


const HelpCenterList = () => {
  const { data } = useGetHelpCenterQuery();
  console.log(data)
  const [deleteHelpCenter, responseInfo] = useDeleteHelpCenterMutation();
            ...
            <div className='col-md-4 ms-auto'>
              <div className='btn-right'>
                <Link
                  ...
                  to="/help-center-list/addHelpCenter">
                  Add Help Center
                </Link>
              </div>
            </div>
                    ...
                    <tr>
                      ...
                      <td >
                        <ul style={{
                          ...
                          <NavLink to={`/help-center-list/editHelpCenter/${datas._id}`}><li>Edit</li></NavLink>
                          <NavLink ><li onClick={() => { deleteHelpCenter({ id: datas._id }) }}>Delete</li></NavLink>
                        </ul>
                      </td>
                    </tr>
                  ))
