...
import { useDeleteBlogsMutation } from '../../../Store/Store'
import Pagination from '../../Pagination';

const Blog = () => {
  const { data } = useGetBlogsQuery();
  console.log(data)
  const [deleteBlog, responseInfo] = useDeleteBlogsMutation();
                    ...
                    <tr>
                      ...
                      <td >
                        <ul style={{
                          ...
                          <NavLink to={`/blog/editBlog/${datas._id}`}><li>Edit</li></NavLink>
                          <NavLink ><li onClick={() => { deleteBlog({ id: datas._id }) }}>Delete</li></NavLink>
                        </ul>
                      </td>
                    </tr>
                  ))
