...
import { useGetContactUsQuery } from '../../../Store/Store';
import { toast, ToastContainer } from "react-toastify";
import { useDeleteContactUsMutation } from '../../../Store/Store'
import Pagination from '../../Pagination';

const Contactus = () => {
  const { data } = useGetContactUsQuery();
  console.log(data)
  const [deleteContactUs, responseInfo] = useDeleteContactUsMutation();
                      ...
                      <tr>
                        ...
                        <td >
                          <ul style={{
                            ...
                            <NavLink to={`/contact-us/editContactUs/${datas._id}`}><li>Edit</li></NavLink>
                            <NavLink ><li onClick={() => { deleteContactUs({ contactus_id: datas._id }) }}>Delete</li></NavLink>
                          </ul>
                        </td>
                      </tr>
                    ))
