...
import { useGetFaqQuery } from '../../../Store/Store';
import { toast, ToastContainer } from "react-toastify";
import { useDeleteFaqMutation } from '../../../Store/Store'
import Pagination from '../../Pagination';

const Faq = () => {
  const { data } = useGetFaqQuery();
  console.log(data)
  const [deleteFaq, responseInfo] = useDeleteFaqMutation();
          ...
          <div className='row'>
            ...
            <div className='col-md-4 ms-auto'>
              <div className='btn-right'>
                <Link
                  className="btn btn-warning rounded-pill btn-sm w-10 mt-25 mt-2" to="/faq/addFaq">
                  Add FAQ
                </Link>
              </div>
            </div>
                    ...
                    <tr>
                      ...
                      <td >
                        <ul style={{
                          ...
                          <NavLink to={`/faq/editFaq/${datas._id}`}><li>Edit</li></NavLink>
                          <NavLink ><li onClick={() => { deleteFaq({ id: datas._id }) }}>Delete</li></NavLink>
