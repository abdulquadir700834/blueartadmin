...
import { useGetSingleFaqQuery } from '../../../Store/Store'
import Form from "react-bootstrap/Form";
import Tabs from "react-bootstrap/Tabs";
import Tab from "react-bootstrap/Tab";
import { toast,ToastContainer } from "react-toastify";
import { useEditFaqMutation } from '../../../Store/Store';
...
const EditFaq = () => {
    ...
    const {data,responseInfo}=useGetSingleFaqQuery(id);
    console.log("single terms data",data)
    const [editFaq,editInfo]=useEditFaqMutation();
    ...
    useEffect(() => {
        ...
        if(editInfo?.data?.status === true) {
            ...
            setTimeout(() => (window.location.href = "/faq"), 2000);
        } else {
