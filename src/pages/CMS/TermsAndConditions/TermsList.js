...
import { useGetTermsAndConditionsQuery, useDeleteTermsMutation } from '../../../Store/Store';
...
const TermsList = () => {
  ...
  const [deleteTerms, responseInfo] = useDeleteTermsMutation();
          ...
          <div className='row'>
            ...
            <div className='col-md-4 ms-auto'>
              <div className='btn-right'>
                <Link
                  className="btn btn-warning rounded-pill btn-sm w-10 mt-2"
                  to="/terms-list/addTerms">
                    ...
                    <tr>
                      ...
                      <td >
                        <ul style={{
                          ...
                          <NavLink to={`/terms-list/editTerms/${datas._id}`}><li>Edit</li></NavLink>
