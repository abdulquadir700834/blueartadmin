...
const EditMediaPublications = () => {
  const { id } = useParams();
  const [showCategory, setShowCategory] = useState({});
  const [editdates, responseInfo2] = useGetOneMediasInfoMutation();
          ...
          <div className="row g-4 justify-content-center">
                    <div className='d-flex flex-wrap justify-content-end px-5'>
                        <div className=''>
                            <div className='btn-right'>
                                <Link className="btn btn-danger  btn-sm w-10" to="/media-publications" >
            ...
            <div className="col-12">
              <Tabs className="border-0 mb-3 settings-tabs px-3">
                <Tab eventKey="" title="Media & Publications More Info">
                  <div className="card">
                    <div className="card-body p-4 p-sm-5">
                        ...
                        <div className="container">
                            <div className="row align-items-center">
                                <div className="col">
                                    <label className="labes">Author</label>
                                </div>
                                <div className="col">
                                    <p className='text-white'>{showCategory?.Author}</p>
                                </div>
                            </div>
                        </div>
                        <div className="container">
                            <div className="row align-items-center">
                                <div className="col">
                                    <label className="labes">Link</label>
                                </div>
                                <div className="col">
                                    <p className='text-white'>{showCategory?.Link}</p>
                                </div>
                            </div>
                        </div>
                        <div className="container">
...
export default EditMediaPublications