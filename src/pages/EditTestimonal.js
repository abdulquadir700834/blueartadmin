...
const EditTestimonal = () => {
  ...
  const [editdates, responseInfo2] = useGetTestimonialMoreInfoMutation();
          ...
          <div className="row g-4 justify-content-center">
            ...
            <div className="col-12">
              <Tabs className="border-0 mb-3 settings-tabs px-3">
                <Tab eventKey="" title="Testimonial More Info">
                  <div className="card">
                    <div className="card-body p-4 p-sm-5">
                      <div className="container">
                        <div className="row align-items-center">
                          <div className="col">
                            <label className="labes">Provider</label>
                          </div>
                          <div className="col">
                            <p className='text-white'>{showCategory?.Provider}</p>
                          </div>
                        </div>
                      </div>
                      <div className="container">
