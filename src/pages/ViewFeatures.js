...
const ViewFeatures = () => {
  ...
  const [editdates, responseInfo2] = useGetOneFeaturesMutation();
          ...
          <div className="row g-4 justify-content-center">
            ...
            <div className="col-12 col-lg-10 col-xl-9 col-xxl-8">
              <Tabs className="border-0 mb-3 settings-tabs">
                <Tab eventKey="" title="View Features">
                  <div className="card">
                      ...
                      <Form >
                        <div className="row g-4">
                          ...
                          <div className='col-12 d-flex flex-wrap align-items-center'>
                            ...
                            <div className='col-6'>
                              <p className='text-white'>{new Date(showCategory.PublishDate).toLocaleDateString()}</p>
                            </div>
                          </div>
                          <div className='col-12 d-flex flex-wrap align-items-center'>
                            <div className='col-6'>
