...
const EditArtistCategories = () => {
  const [isLoading, setIsLoading] = useState(false);
  const { id } = useParams();
  let navigate = useNavigate();
  const [logoFile, setLogoFile] = useState("");
  const [showCategory, setShowCategory] = useState({});
  const [editdates, responseInfo2] = useGetOneArtistCategoryMutation();
  const [editCategory, responseInfo] = useEditArtistCategoryMutation();
          ...
          <div className="row g-4 justify-content-center">
            ...
            <div className="col-12 col-lg-10 col-xl-9 col-xxl-8">
              <Tabs className="border-0 mb-3 settings-tabs">
                <Tab eventKey="" title="Edit Artist">
                  <div className="card">
...
export default EditArtistCategories