...
import { useGetItemViewsByCountryQuery } from '../../../Store/Store';

const GetItemViewsByCountry = (props) => {
  const monthdata = useGetItemViewsByCountryQuery();
      ...
      options: {
        ...
        tooltip: {
          ...
          custom: ({ seriesIndex, dataPointIndex, w }) => {
            const selectedData = graphData?.[dataPointIndex];
            const userDetails = selectedData
              ? `ItemName: ${selectedData.item_title}`
              : '';
...
export default GetItemViewsByCountry;
