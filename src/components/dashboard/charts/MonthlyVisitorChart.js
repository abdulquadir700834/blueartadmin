...
import { useGetmonthlyloginQuery } from '../../../Store/Store';

const MonthlyVisitorChart = (props) => {
    const monthdata = useGetmonthlyloginQuery();
    ...
    console.log("monthdatagraph:", monthdata)
    ...
    useEffect(() => {
        if (monthdata.data) {
            ...
            console.log("updatedOptionsMonthlyChart:", updatedOptions)
