...
import { useGetartProductDetailQuery } from '../../../Store/Store';

const ArtProductDetailChart = (props) => {
  const monthdata = useGetartProductDetailQuery();
  console.log("artProductworkMOnthChart:", monthdata)
...
export default ArtProductDetailChart;